      ...
      {!showResult ? (
        ...
        <div style={{ color: darkMode ? "white" : "black" }} id="main">
          <div style={{display: "flex", flexDirection:"row"}} className="result-title">
            <svg
              style={{float: "left", backgroundColor: "#415d7a", borderRadius: "5px", position: "relative", bottom: "6px"}}
          ...
          <div className="result-data">
            <svg
            style={{float: "left", backgroundColor: "#415d7a", borderRadius: "11px", position: "relative", bottom: "6px"}}
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
              fill="currentColor"
